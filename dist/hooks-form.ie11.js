...
var BaseForm = function (props) {
  ...
  var rules = props.rules,
      ...
      _e = props.show_required,
      show_required = _e === void 0 ? true : _e,
      _f = props.extend_text,
      _g = props.is_required,
      is_required = _g === void 0 ? 2 : _g,
      otherparams = __rest(props, ["rules", "label", "value", "input_type", "name", "className", "disabled", "show_required", "extend_text", "is_required"]);

  var params = __assign(__assign({}, otherparams), {
    value: value,
    defaultValue: value,
    disabled: disabled
  });

  var FormItem = FormItems[input_type];
  ...
  return React__default.createElement("div", {
    ...
    as: React__default.createElement(FormItem, __assign({}, params)),
    defaultValue: value,
    control: control,
    rules: rules,
    name: name
...
var SelectCompanent = function (props) {
  var name = props.name,
      style = props.style,
      value = props.value,
      ...
      _a = props.mode,
      mode = _a === void 0 ? "default" : _a,
      _b = props.show_all,
      show_all = _b === void 0 ? false : _b,
      _c = props.value_key,
      value_key = _c === void 0 ? "id" : _c,
      _d = props.show_empty,
      show_empty = _d === void 0 ? false : _d,
      _e = props.label_key,
      label_key = _e === void 0 ? "name" : _e,
      _f = props.placeholder,
  ...
  var renderEmpty = function () {
    if (mode === "default") {
      var has_empty_value = !find$2(new_options).call(new_options, function (l) {
        return l.id === value;
      });
      return has_empty_value && React__default.createElement(antd.Checkbox, {
        value: value
      }, "==", value, "==\u65E0\u5BF9\u5E94\u9009\u9879==");
    } else if (mode === "multiple") {
      var options_empty_array_1 = [];
      value === null || value === void 0 ? void 0 : forEach$2(value).call(value, function (element) {
        var has_value = find$2(new_options).call(new_options, function (l) {
          return l[value_key] === element;
        });

        !has_value && options_empty_array_1.push(element);
      });
      return React__default.createElement(React__default.Fragment, null, options_empty_array_1 === null || options_empty_array_1 === void 0 ? void 0 : map$2(options_empty_array_1).call(options_empty_array_1, function (k) {
  ...
  if (!isArray$1(new_options)) {
    return React__default.createElement(Group, __assign({}, props_data, otherParams));
  }

  return React__default.createElement(Group, __assign({}, props_data, otherParams), map$2(new_options).call(new_options, function (item, index) {
    return React__default.createElement(antd.Checkbox, __assign({}, item, {
...
var DatePickerComponent = function (props) {
  var _a = props.placeholder,
      ...
      _b = props.mode,
      mode = _b === void 0 ? "date" : _b,
      onChange = props.onChange,
      otherparams = __rest(props, ["placeholder", "mode", "onChange"]);

  var value = otherparams.value,
      defaultValue = otherparams.defaultValue;

  var _c = __read(React.useState(value || defaultValue || undefined), 2),
      _value = _c[0],
      setValue = _c[1];
  ...
  var new_value = _value ? moment(new Date(isObject$1(value) ? value["start_time"] : value)) : undefined;

  var all_props = __assign(__assign({
    allowClear: false,
  ...
  return React__default.createElement(antd.DatePicker, __assign({}, all_props));
};

var DatetimePicker = function (props) {
  return React__default.createElement(DatePickerComponent, __assign({}, props, {
    mode: "time"
  }));
};
...
var Form = function (props) {
  var data = props.data,
      ...
      _a = props.layout,
      layout = _a === void 0 ? "inline" : _a,
      _b = props.labelAlign,
      labelAlign = _b === void 0 ? "right" : _b,
      _c = props.hideRequiredMark,
      hideRequiredMark = _c === void 0 ? false : _c;

  var renderForm = function () {
    return React__default.createElement(React__default.Fragment, null, map$2(data).call(data, function (l) {
      return onRenderHooks(l, defaultValues);
    }));
  };

  var className = "hooks-form hooks-form-" + layout + " label-" + labelAlign + " " + (hideRequiredMark ? "hide_require" : "");
  return React__default.createElement("form", {
    className: className
  }, children ? children : renderForm());
};

var InputCompanent = function (props) {
  var value = props.value,
      _a = props.placeholder,
      placeholder = _a === void 0 ? "请输入" : _a,
      style = props.style,
      otherParams = __rest(props, ["value", "placeholder", "style"]);

  return React__default.createElement(antd.Input, __assign({
    key: props.id + "-input",
    autoComplete: "off"
  }, otherParams, {
    defaultValue: value,
...
var InputNumberComponent = function (props) {
  var _a = props.placeholder,
      placeholder = _a === void 0 ? "请输入" : _a,
      otherparams = __rest(props, ["placeholder"]);

  return React__default.createElement(antd.InputNumber, __assign({}, otherparams, {
    placeholder: placeholder
  }));
};

var Group$1 = antd.Radio.Group;

var SelectCompanent$1 = function (props) {
  var name = props.name,
      style = props.style,
      value = props.value,
      options = props.options,
      ...
      mode = _a === void 0 ? "default" : _a,
      _b = props.value_key,
      value_key = _b === void 0 ? "id" : _b,
      _c = props.show_empty,
      show_empty = _c === void 0 ? false : _c,
      _d = props.label_key,
      label_key = _d === void 0 ? "name" : _d,
      otherParams = __rest(props, ["name", "style", "value", "options", "disabled", "mode", "value_key", "show_empty", "label_key"]);
  ...
  var renderEmpty = function () {
    if (mode === "default") {
      ...
      return has_empty_value && React__default.createElement(antd.Radio, {
        value: value
      }, "==", value, "==\u65E0\u5BF9\u5E94\u9009\u9879==");
    }
  ...
  if (!isArray$1(new_options)) {
    return React__default.createElement(Group$1, __assign({}, props_data, otherParams));
  }

  return React__default.createElement(Group$1, __assign({}, props_data, otherParams), map$2(new_options).call(new_options, function (item, index) {
    return React__default.createElement(antd.Radio, __assign({}, item, {
      value: "" + item[value_key],
      label: item[label_key],
      disabled: !!disabled || !!item.disabled,
      key: item[value_key] + "-" + index
...
var SelectCompanent$2 = function (props) {
  var name = props.name,
      style = props.style,
      value = props.value,
      options = props.options,
  ...
  React.useEffect(function () {
    ...
    if (isArray$1(options)) {
      var all_option = (_a = {}, _a[value_key] = "", _a[label_key] = "全部", _a);

      if (show_all) {
        setOptions(__spread([all_option], options));
      } else {
        setOptions(options);
      }
    }
  ...
  var props_data = {
    ...
    filterOption: function (v, data) {
      var _context;

      var props = data.props;
      var text = props[label_key] || "";
      v = v ? v.replace(/(^\s*)|(\s*$)/g, "") : null;
      return !v || indexOf$3(_context = ("" + text).toLowerCase()).call(_context, ("" + v).toLowerCase()) !== -1;
    }
  };

  if (!isArray$1(new_options)) {
    return React__default.createElement(antd.Select, __assign({}, props_data, otherParams, {
  ...
  return React__default.createElement(antd.Select, __assign({}, props_data, otherParams, {
    placeholder: placeholder
  }), map$2(new_options).call(new_options, function (item, index) {
    return React__default.createElement(Option, __assign({}, item, {
      value: "" + item[value_key],
      label: item[label_key],
      disabled: !!disabled || !!item.disabled,
      key: item[value_key] + "-" + index
...
var onRenderHooks = function (item, defaultValue) {
  ...
  var value = getValueByPath(defaultValue, item === null || item === void 0 ? void 0 : item.name) || (item === null || item === void 0 ? void 0 : item.defaultValue);
  return React__default.createElement(BaseForm, __assign({
...
var USES_TO_LENGTH$4 = arrayMethodUsesToLength('some');
...
class Draggable extends React__default.Component {
  ...
  /*: DraggableProps*/
    ...
    _defineProperty$1(this, "onDragStart", (e, coreData) => {
    ...
    _defineProperty$1(this, "onDrag", (e, coreData) => {
    ...
    _defineProperty$1(this, "onDragStop", (e, coreData) => {
  ...
  /*: ReactElement<any>*/
  {
    ...
    return React__default.createElement(DraggableCore, _extends({}, draggableCoreProps, {
...
_defineProperty$1(Draggable, "propTypes", { // Accepts all props <DraggableCore> accepts.
...
_defineProperty$1(Draggable, "defaultProps", { ...DraggableCore.defaultProps,
  axis: 'both',
  bounds: false,
